...
while True:
	x = input("1:바이러스 노출정도 문답, 2:관련지식문답(해당 번호를 입력하세요.) :")
	if x == "1":
		...
		a7 = input("Q7 : 일주일에 평균 외출 횟수는 어느정도입니까?(숫자로 응답/ 예시: 1~7))\n")
		a8 = input("Q8 : 외출 시 마스크의 KF 지수는 어느정도입니까?(숫자로 응답/예시: 80 or 94)\n")
		a9 = input("Q9 : 평소 외부활동을 활발히 하는 요일은 언제입니까?\n")
		a10 = input("Q10 : 노래방,PC방 같은 제한시설을 이용한적 있습니까?(Y,N)\n")

		
		print('답변하신 내용입니다.:',a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)
		...
		print('점수: ',result)
		if result < 2:
			print("당신의 마스크는 구멍뚫린 마스크입니다.",
				"\n!예방에 주의가 필요합니다!")
		elif result < 4:
			print("당신의 마스크는 바람막이 마스크입니다.",
				"\n예방을 위해 좀 더 주의를 기울여 주세요!")
		elif result < 6:
			print("당신의 마스크는 그럭저럭 마스크입니다.")
		elif result < 8:
		...
		if a4.upper() == "X":
			result += 1
		else : print("Q4 review : 기침이나 재채기를 할 때는 손대신 소매로 가리고 하시는 것을 권유드립니다.")
		if a5 == "14":
			result += 1
